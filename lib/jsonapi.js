...
exports.reducer = exports.requireEntity = exports.deleteEntity = exports.updateEntity = exports.readEndpoint = exports.createEntity = exports.uploadFile = exports.setAccessToken = exports.setEndpointPath = exports.setEndpointHost = exports.setEndpointFetchMode = exports.IS_UPDATING = exports.IS_DELETING = undefined;
...
// Action creators
var setEndpointFetchMode = exports.setEndpointFetchMode = (0, _reduxActions.createAction)(_constants.API_SET_ENDPOINT_FETCH_MODE);
...
var createEntity = exports.createEntity = function createEntity(entity) {
  ...
  return function (dispatch, getState) {
    ...
    var fetchMode = _getState$api$endpoin.fetchMode;
...
var readEndpoint = exports.readEndpoint = function readEndpoint(endpoint) {
  ...
  return function (dispatch, getState) {
    ...
    var fetchMode = _getState$api$endpoin2.fetchMode;
...
var updateEntity = exports.updateEntity = function updateEntity(entity) {
  ...
  return function (dispatch, getState) {
    ...
    var fetchMode = _getState$api$endpoin3.fetchMode;
...
var deleteEntity = exports.deleteEntity = function deleteEntity(entity) {
  ...
  return function (dispatch, getState) {
    ...
    var fetchMode = _getState$api$endpoin4.fetchMode;
...
}), (0, _defineProperty3.default)(_handleActions, _constants.API_SET_ENDPOINT_FETCH_MODE, function (state, _ref9) {
  var fetchMode = _ref9.payload;

  return _immutable2.default.fromJS(state).setIn(['endpoint', 'fetchMode'], fetchMode).toJS();
